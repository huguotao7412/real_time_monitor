...
class SubjectTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._breath_unit_label.setStyleSheet("color: #7f8c8d; font-size: 11pt;")
        ...
        self._heart_bpm_label.setFont(QFont("Segoe UI", 52, QFont.Weight.Bold))
        ...
        self._heart_unit_label.setStyleSheet("color: #7f8c8d; font-size: 11pt;")
